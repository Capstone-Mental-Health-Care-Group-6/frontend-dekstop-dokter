...
const Routing = () => {
  return (
    <Routes>
      ...
      <Route path="/dokter/register/data-pribadi" element={<RegisDataPribadi />} />
      <Route path="/dokter/register/data-akademik" element={<RegisDataAkademik />} />
      <Route path="/dokter/register/dokumen" element={<RegisDokumen />} />
      <Route path="/dokter/register/pengalaman" element={<RegisPengalaman />} />
