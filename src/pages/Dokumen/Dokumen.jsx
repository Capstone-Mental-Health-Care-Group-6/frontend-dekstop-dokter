      ...
      <div className="dokumen">
        <div className="container">
          ...
          <form className="dokumen-form" onSubmit={handleFileChange}>
            ...
            <div className="row">
              <Label htmlFor="sippk">
                Surat Izin Praktik Psikologi Klinis (SIPPK)
              </Label>
              <div className="input-group mb-3">
                <div className="form-control-wrapper">
                  <Input
                    type="text"
                    className={`form-control mb-2 ${
                      errorMessages.sippk ? "is-invalid" : ""
                    }`}
                    id="sippk"
                    name="sippk"
              ...
              <div className="input-group mb-3">
                <div className="form-control-wrapper">
                  <Input
                    type="text"
                    className={`form-control mb-2 ${
                      errorMessages.ijazah ? "is-invalid" : ""
                    }`}
                    id="ijazah"
                    name="ijazah"
            ...
            <div className="row">
              <Label htmlFor="strpk">
                Surat Tanda Registrasi Psikologi Klinis (STRPK)
              </Label>
              <div className="input-group mb-3">
                <div className="form-control-wrapper">
                  <Input
                    type="text"
                    className={`form-control mb-2 ${
                      errorMessages.strpk ? "is-invalid" : ""
                    }`}
                    id="strpk"
                    name="strpk"
