...
function clsx() {
  ...
  var classes = args.reduce(function(classes2, arg) {
    ...
    if (Array.isArray(arg)) {
      classes2.push(clsx.apply(void 0, arg));
    }
...
function ClickableEmojiButton(_ref) {
  var _clsx;
  var emojiNames2 = _ref.emojiNames, unified = _ref.unified, hidden = _ref.hidden, hiddenOnSearch = _ref.hiddenOnSearch, _ref$showVariations = _ref.showVariations, showVariations = _ref$showVariations === void 0 ? true : _ref$showVariations, hasVariations = _ref.hasVariations, children = _ref.children;
...
function EmojiImg(_ref) {
  var emojiName2 = _ref.emojiName, style = _ref.style, _ref$lazyLoad = _ref.lazyLoad, lazyLoad = _ref$lazyLoad === void 0 ? false : _ref$lazyLoad, imgUrl = _ref.imgUrl, onError = _ref.onError;
...
function NativeEmoji(_ref) {
  var unified = _ref.unified, style = _ref.style;
...
function ViewOnlyEmoji(_ref) {
  var emoji = _ref.emoji, unified = _ref.unified, emojiStyle = _ref.emojiStyle, size = _ref.size, lazyLoad = _ref.lazyLoad, _ref$getEmojiUrl = _ref.getEmojiUrl, getEmojiUrl = _ref$getEmojiUrl === void 0 ? emojiUrlByUnified : _ref$getEmojiUrl;
...
function Search() {
  ...
  return (0, import_react.createElement)(Relative, {
    ...
    id: "epr-search-id",
    "aria-atomic": "true"
  }, statusSearchResults) : null, (0, import_react.createElement)("div", {
...
function PickerRootElement(_ref2) {
  ...
  return (0, import_react.createElement)("aside", {
    className: clsx(ClassNames.emojiPicker, "epr-main", (_clsx = {}, _clsx[ClassNames.searchActive] = searchModeActive, _clsx[ClassNames.darkTheme] = theme === Theme.DARK, _clsx[ClassNames.autoTheme] = theme === Theme.AUTO, _clsx)),
    ref: PickerMainRef,
    style
  }, children);
}
